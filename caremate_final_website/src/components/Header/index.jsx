    ...
    <>
            ...
            <div className="cs_main_header_in">
              <div className="cs_main_header_left">
                <Link className="cs_site_branding" to="/">
                  <img src={logoSrc} alt="Logo" width={100} height={100} style={{
                    height: '5rem',
                    width: 'auto',
                  }} />
                </Link>
                    ...
                    <li className="menu-item-has-children">
                      ...
                      <DropDown>
                        <ul>
                          ...
                          <li>
                            <Link to="/find-bed">Find Bed</Link>
                          </li>
                          <li>
                            <Link to="">Disease Prediction</Link>
                          </li>
                          <li>
      ...
      <div className={`cs_sidenav ${sideNav ? 'active' : ''}`}>
        ...
        <div className="cs_sidenav_in">
          ...
          <IconBoxStyle11
            title="Location"
            subTitle="Manipal University Jaipur , Rajasthan , India"
