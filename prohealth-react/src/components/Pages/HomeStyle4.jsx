...
const testimonialData = [
  ...
  {
    text: '"I recently had to bring my child to Caremate for a minor injury, and I was so impressed with the care he received. The pediatrician was great with him and made him feel at ease.”',
    ratingNumber: '5',
    avatarImgUrl: '/images/home_4/avatar_2.png',
    avatarName: 'Sophia Torres',
    avatarDesignation: 'New York, USA',
  ...
  {
    text: '"Caremate has been a game-changer for me. The doctors are caring and highly skilled, and the staff is always friendly and accommodating. We hope for the best wishes.”',
    ratingNumber: '5',
    avatarImgUrl: '/images/home_4/avatar_3.png',
    avatarName: 'John Dupont',
    avatarDesignation: 'Manhattan, USA',
  ...
  {
    text: '“I had a great experience with Caremate. The staff were friendly and professional, and the doctor took the time to answer all my questions and address my concerns.”',
    ratingNumber: '5',
    avatarImgUrl: '/images/home_4/avatar_4.png',
    avatarName: 'Allen Duarte',
    avatarDesignation: 'California, USA',
    ...
    <>
      ...
      <Section topMd={170} topLg={120} topXl={100}>
        <AboutSectionStyle5
          ...
          titleUp="ABOUT US"
          title="Caremate is a team of experienced medical professionals"
          subTitle=""
      ...
      >
        <TestimonialSectionStyle4
          ...
          avatarListTitle="150+ patients are reviews about Caremate"
          avatarList={[
