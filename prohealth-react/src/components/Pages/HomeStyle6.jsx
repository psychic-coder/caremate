...
const testimonialData = [
  {
    text: '"An absolute game-changer! Caremate has made our hospital visits so much easier and stress-free. The OPD queue management is incredibly efficient, and we can now check bed availability in real time, which helps us plan better. It’s truly a modern healthcare solution!”',
    ratingNumber: '5',
    avatarImgUrl: '/images/home_1/avatar_2.png',
    avatarName: 'Rishi Joshi',
